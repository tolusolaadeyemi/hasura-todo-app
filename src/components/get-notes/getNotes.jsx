 ...
 const deleteNoteId = (note_id,name) => {
  ...
  markItemAsDone = event => {
    ...
    <div className="flex mb-4 items-center">
        ...
        <button id="myFinished" onClick={this.markItemAsDone} key={item.note_id}className="flex-no-shrink p-1 mr-9 ml-9 mb-2 border-2 rounded hover:text-white border-green hover:bg-green">mark as done ✅</button>
